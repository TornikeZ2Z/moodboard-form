-- ============================================================
-- ESPACIO e-mail via Google (Apps Script relay) — replaces the
-- Resend version. Deploy google-apps-script.gs first, then fill
-- the TWO placeholders below and run this whole file.
-- ============================================================
...
insert into private.config (key, value) values
  ('gscript_url',    'PASTE_YOUR_WEBAPP_URL_HERE'),
  ('gscript_secret', 'PASTE_A_LONG_RANDOM_SECRET_HERE')
